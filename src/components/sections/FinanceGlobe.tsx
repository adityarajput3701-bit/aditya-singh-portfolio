...
export function FinanceGlobe() {
  ...
  // Smoother Parallax movement calculations
  ...
  return (
    ...
    >
      ...
      <div 
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#e8a94a]/10 blur-[140px] rounded-full pointer-events-none -z-10" 
        aria-hidden="true"
      />
      ...
      <div className="max-w-6xl w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <motion.div
          ...
          className="relative w-full aspect-[4/3] lg:aspect-square rounded-2xl overflow-hidden border border-white/15 shadow-2xl bg-[#0d1420]/80 backdrop-blur-md"
        >
          <Image
